...
scb_container="$(buildah from securecodebox/engine@sha256:9d7d0a633b0daf32af5faa9e5deac2a47fb7da077ffcd981ab00f7c87c8b1a3e)" # to be changed
...
buildah config \
  ...
  --label "${oci_prefix}.version=1.0.10" \
